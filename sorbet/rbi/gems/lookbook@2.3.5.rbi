...
class Lookbook::BaseComponent < ::ViewComponent::Base
  ...
  # source://view_component/3.21.0/lib/view_component/base.rb#527
...
class Lookbook::Button::Component < ::Lookbook::BaseComponent
  ...
  # source://view_component/3.21.0/lib/view_component/slotable.rb#87
  def with_dropdown(*args, **_arg1, &block); end

  # source://view_component/3.21.0/lib/view_component/slotable.rb#100
...
module Lookbook::Button::Component::GeneratedSlotMethods
  # source://view_component/3.21.0/lib/view_component/slotable.rb#92
  def dropdown; end

  # source://view_component/3.21.0/lib/view_component/slotable.rb#96
  def dropdown?; end
end
...
class Lookbook::ButtonGroup::Component < ::Lookbook::BaseComponent
  ...
  # source://view_component/3.21.0/lib/view_component/slotable.rb#158
  def with_button(*args, **_arg1, &block); end

  # source://view_component/3.21.0/lib/view_component/slotable.rb#163
  def with_button_content(content); end

  # source://view_component/3.21.0/lib/view_component/slotable.rb#169
...
module Lookbook::ButtonGroup::Component::GeneratedSlotMethods
  # source://view_component/3.21.0/lib/view_component/slotable.rb#179
  def buttons; end

  # source://view_component/3.21.0/lib/view_component/slotable.rb#183
  def buttons?; end
end
...
class Lookbook::Engine < ::Rails::Engine
  # source://lookbook//lib/lookbook/engine.rb#85
  def opts; end

  # source://lookbook//lib/lookbook/engine.rb#89
  def parser; end

  # source://lookbook//lib/lookbook/engine.rb#93
  def reloaders; end
  ...
  class << self
    ...
    # @return [Boolean]
    #
    # source://lookbook//lib/lookbook/engine.rb#112
    ...
    # source://lookbook//lib/lookbook/engine.rb#246
    def load_pages(changes = T.unsafe(nil)); end

    # source://lookbook//lib/lookbook/engine.rb#236
    def load_previews(changes = T.unsafe(nil)); end

    # source://lookbook//lib/lookbook/engine.rb#100
    def mount_path; end

    # @return [Boolean]
    #
    # source://lookbook//lib/lookbook/engine.rb#104
    def mounted?; end

    # source://lookbook//lib/lookbook/engine.rb#253
    def notify_clients(changes = T.unsafe(nil)); end

    # source://lookbook//lib/lookbook/engine.rb#182
    def page_paths; end
    ...
    # source://lookbook//lib/lookbook/engine.rb#135
    def panels; end

    # source://lookbook//lib/lookbook/engine.rb#231
    def preview_controller; end

    # @return [Boolean]
    #
    # source://lookbook//lib/lookbook/engine.rb#119
    ...
    # source://lookbook//lib/lookbook/engine.rb#215
    def previews; end

    # @return [Boolean]
    #
    # source://lookbook//lib/lookbook/engine.rb#108
    def reloading?; end

    # source://lookbook//lib/lookbook/engine.rb#151
    def run_hooks(event_name, *args); end

    # source://lookbook//lib/lookbook/engine.rb#127
    def runtime_context; end

    # source://lookbook//lib/lookbook/engine.rb#143
    def tags; end

    # source://lookbook//lib/lookbook/engine.rb#131
    def theme; end

    # source://lookbook//lib/lookbook/engine.rb#165
    def view_paths; end

    # source://lookbook//lib/lookbook/engine.rb#123
    def websocket; end
